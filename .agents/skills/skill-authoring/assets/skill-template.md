...
metadata:
  version: '1.0.0' # Optional: semantic version metadata for Forward Nexus
---
...
- [{Template name}](assets/{TEMPLATE}.md) - {Template or static resource}
```
...
- [ ] If included, version lives under `metadata.version`
...
# Optional: run extraction script if provided
