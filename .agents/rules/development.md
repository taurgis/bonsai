---
trigger: always_on
description: "Development instructions for all coding work in this repository: general and CLI-specific best practices, plus the mandatory ponytail and thermo-nuclear code quality review workflow.\n"
---
