---
trigger: always_on
description: "When and how to run the read-only review subagents (Senior QA Engineer, Senior Code Reviewer, Business Analyst) and how to act on their leveled feedback (blocker/major/minor/nit).\n"
---
