---
trigger: glob
description: "Require Senior Release Manager for CI/CD, Changesets, packaging, and release automation changes"
globs: .github/workflows/**/*.yml, .github/workflows/**/*.yaml, .changeset/config.json, package.json, pnpm-lock.yaml, .github/agents/senior-release-manager.agent.md
---
