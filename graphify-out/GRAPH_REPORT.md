...
## Corpus Check
- 1073 files · ~1,055,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10275 nodes · 10782 edges · 1014 communities (955 shown, 59 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ba7f345`
...
- `readTimingBaseline()` --calls--> `parseTimingBaseline()`  [EXTRACTED]
  testing/regression/run-suite.mjs → src/lib/research/regression.ts
...
## Communities (1014 total, 59 thin omitted)
...
Cohesion: 0.05
Nodes (37): Angular `@Input()` / `@Output()` are still covered by the component rules, Baseline Comparison Tracks Issue Identity, `--changed-since` Shows Only New Issues, Class Instance Members Are Tracked, CSS Health Candidates Are Advisory, Decorated Members Are Skipped By Default, Don't Create Config Unless Needed, Duplication Modes Affect What's Detected (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (29): Args vs Flags: When to Use Each, Behavior matrix, Catch and rewrite errors for humans, CLI Design Principles, Configuration Files, Environment variable naming, Error message anatomy, Error Messages (+21 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (26): CLI Output Design, Color semantics, Debug Logging with the `debug` Package, Dynamic flag value completions, Full color-off checklist, JSON output, Key-Value (single entity), Multi-step tasks (+18 more)
...
Cohesion: 0.09
Nodes (42): ConfigCommand, configScopeFlags(), iso, ConfigGet, ConfigIndex, ConfigScope, effectiveConfig(), loadStorageMode() (+34 more)
...
Cohesion: 0.09
Nodes (21): All arg types, Args, Args vs Flags, Built-in flag types, Command Lifecycle, Common flag options, Custom reusable flag, Error Handling (+13 more)
...
Cohesion: 0.06
Nodes (30): 1. Root fetch command, 2. `import`, 3. `status`, 4. `inspect`, 5. `list`, 6. `prune`, 7. `config`, Command-Line Flags (+22 more)

### Community 11 - "Community 11"
Cohesion: 0.10
Nodes (20): bin/dev.js, bin/run.js, Built-in hook events, Command Discovery Strategies, Custom hook events, Hooks, Key `oclif` settings, Manifest Generation (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.10
Nodes (20): Anti-Patterns to Avoid, Bad Examples, Extraction Script, File References, Good Examples, Guidelines, Optional Directories, Progressive Disclosure Model (+12 more)

### Community 13 - "Community 13"
Cohesion: 0.10
Nodes (19): Apex Skill Pattern, API/Framework Skill, CLI Command Skill, Code Blocks with Context, Code Example Patterns, Command Reference Table, Configuration Skill, Content Organization Patterns (+11 more)
...
Cohesion: 0.14
Nodes (17): assertRenderedHttpOk(), BLOCKED_ASSET_URLS, BrowserFetchOptions, BrowserFetchResult, CdpClient, fetchRenderedHtml(), fetchRenderedHtmlOnce(), findChromePath() (+9 more)

### Community 16 - "Community 16"
Cohesion: 0.25
Nodes (7): Default Workflow, Fallbacks, Freshness Policy, Invocation, Official Docs Researcher Agent, Response Contract, Scope
...
Cohesion: 0.11
Nodes (18): CLI Error Handling and Confirmation Patterns, Confirmation Patterns by Risk Level, Core set (use these by default), Error Formatting in --json Mode, Error Message Templates, Exit Codes, Extended set (use for richer scripting), Handling Ctrl+C (+10 more)
...
Cohesion: 0.12
Nodes (24): applyCaptureMetadata(), CAPTURE_DEPS, FetchCommand, fetchFailureGuidance(), handleStaleRevalidationResult(), resolveFreshness(), SummaryLevel, checkMaxAgeExpired() (+16 more)
...
Cohesion: 0.12
Nodes (15): Advanced Usage, Assets, Basic Usage, Example 1: Safe fetch with retry, Example 2: Normalize API results, Examples, How to Use, Issue: Inconsistent async errors (+7 more)

### Community 25 - "Community 25"
Cohesion: 0.12
Nodes (15): Color, Color detection — env vars, Interactive prompts → `@inquirer/prompts`, JSON-safe spinner pattern, Multi-step tasks → `listr2`, OCLIF UX and Output, Progress bar → `cli-progress`, Quick Reference (+7 more)

### Community 26 - "Community 26"
Cohesion: 0.12
Nodes (15): Array output, CLI Output Formats — Reference, Column alignment, Debug Output Namespace Patterns, Environment Variable Quick Reference, Grep-compatible tables, jq integration examples, JSON Design Conventions (+7 more)
...
Cohesion: 0.12
Nodes (22): CHROME_SELECTORS, cleanDocsChrome(), dropDataImages(), removeMatching(), FIXTURES, detectLanguage(), flattenCodeStructure(), normalizeCodeBlocks() (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.14
Nodes (13): Analytics in `postrun`, Auth check in `prerun`, `command_not_found`, Common Hook Patterns, Custom Events, Fuzzy match in `command_not_found`, Hook Error Handling, Hook Event Payloads (+5 more)
...
Cohesion: 0.08
Nodes (40): activeChildrenOf(), buildSectionArtifacts(), persistSectionArtifacts(), atomicWriteFile(), extractSection(), handleArrayItem(), handleNestedProp(), handleRootProp() (+32 more)

### Community 36 - "Community 36"
Cohesion: 0.28
Nodes (10): allProductionFiles(), countLines(), findOffenders(), git(), isBinary(), main(), readContent(), rootDir (+2 more)

### Community 37 - "Community 37"
Cohesion: 0.11
Nodes (18): devDependencies, @changesets/cli, fallow, husky, jsdom, lint-staged, oclif, prettier (+10 more)

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (25): scripts, audit:cli, build, changeset, changeset:status, docs:build, docs:dev, docs:preview (+17 more)
...
Cohesion: 0.05
Nodes (37): Agent research: Bonsai workflow vs native web search, Answer delivery, Antigravity, Antigravity — Bonsai workflow, Antigravity — Bonsai workflow, Antigravity — Bonsai workflow, Antigravity — Native web search, Antigravity — Native web search (+29 more)
...
Cohesion: 0.12
Nodes (15): Avoid, Beginner-Friendly Moves, Beginner Technical Writing, Best Practice References, Code Example Rules, Example, Explanation Pattern, Final Check (+7 more)
...
Cohesion: 0.05
Nodes (38): [API documentation], [API documentation](https://prismjs.com/extending.html#api-documentation), Compressed, [Creating a new language definition], [Creating a new language definition](https://prismjs.com/extending.html#creating-a-new-language-definition), [Declaring dependencies], [Declaring dependencies](https://prismjs.com/extending.html#declaring-dependencies), [Dependencies] (+30 more)
...
Cohesion: 0.11
Nodes (18): bin, bonsai, description, engines, node, files, homepage, main (+10 more)
...
Cohesion: 0.22
Nodes (8): Anti-Nitpick Discipline, Default Workflow, Deterministic Analysis with Fallow, Guardrails, Primary Objective, Reporting Format, Senior Code Reviewer Agent, Surface-Aware Review Defaults
...
Cohesion: 0.22
Nodes (8): Decision Ladder, Development Principles (Ponytail Edition), Mark Intentional Simplifications, Never Lazy About (Non-Negotiable), Ponytail Skills (Applicable if available), Testing, Understanding the Codebase (Applicable if the "graphify" skill is available), Write Less, Write Clear
...
Cohesion: 0.29
Nodes (6): Default Workflow, Guardrails, Primary Objective, Reporting Format, Senior Quality Engineer Agent, Validation Expectations
...
Cohesion: 0.08
Nodes (30): allFixtures, argv, BASELINE_DIR, CAPTURE_DEPS, CURRENT_DIR, fileExists(), filters, FIXTURES_PATH (+22 more)

### Community 92 - "Community 92"
Cohesion: 0.29
Nodes (6): 1. Create Folder Structure, 2. Copy This SKILL.md Template, 3. Validation Checklist, 4. Example: Completed Template, 5. Quick Commands, Skill Template

### Community 93 - "Community 93"
Cohesion: 0.29
Nodes (6): Coordination, Guardrails, Mandatory Subagent, Release Management Review Requirement, Scope, When not to Use
...
Cohesion: 0.22
Nodes (8): Cache Operations, Fetch Rules, Invocation, Manual Fallbacks, Required Pre-Step, Source Rules, Web Research Skill, When This Does Not Apply
...
Cohesion: 0.50
Nodes (4): `inspect`: Target Evidence Bundle, JSON Output Structure, Target Flags, Usage
...
Cohesion: 0.50
Nodes (3): Examples, File References, Rules
...
Cohesion: 0.06
Nodes (34): Add hook examples, Add hook examples, Compressed, Cursor, Cursor, Detailed, GitHub Copilot (the source format), GitHub Copilot (the source format) (+26 more)
...
Cohesion: 0.15
Nodes (12): access, baseBranch, changelog, commit, fixed, ignore, linked, $schema (+4 more)
...
Cohesion: 0.04
Nodes (44): Compressed, Detailed, Entity escaping, Entity escaping, Excluding content, Excluding content, Extending the Sitemaps protocol, Extending the Sitemaps protocol (+36 more)
...
Cohesion: 0.05
Nodes (36): Adding state to a component {/*adding-state-to-a-component*/}, Avoiding recreating the initial state {/*avoiding-recreating-the-initial-state*/}, Caveats {/*caveats*/}, Caveats {/*setstate-caveats*/}, Checkbox (boolean) {/*checkbox-boolean*/}, Counter (number) {/*counter-number*/}, Form (nested object) {/*form-nested-object*/}, Form (object) {/*form-object*/} (+28 more)
...
Cohesion: 0.06
Nodes (35): Caveats {/*caveats*/}, Connecting to a chat server {/*connecting-to-a-chat-server*/}, Connecting to an external system {/*connecting-to-an-external-system*/}, Controlling a modal dialog {/*controlling-a-modal-dialog*/}, Controlling a non-React widget {/*controlling-a-non-react-widget*/}, Custom `useChatRoom` Hook {/*custom-usechatroom-hook*/}, Custom `useIntersectionObserver` Hook {/*custom-useintersectionobserver-hook*/}, Custom `useWindowListener` Hook {/*custom-usewindowlistener-hook*/} (+27 more)
...
Cohesion: 0.09
Nodes (33): DocsEngine, DocsFramework, emptyCapabilities(), Evidence, MachineReadableType, PageMapEntry, SearchCapability, SearchProvider (+25 more)
...
Cohesion: 0.50
Nodes (3): 3.0.0, Major Changes, @taurgis/bonsai

### Community 332 - "Community 332"
Cohesion: 0.15
Nodes (12): Adding a new site module, Capability: custom fetching, How a site is matched, Registered sites, `salesforce-developer` — Salesforce Developer, `salesforce` — Salesforce Help, Site Modules, The Salesforce modules in detail (+4 more)
...
Cohesion: 0.10
Nodes (22): SectionSummary, ResearchPrune, CacheStatus, describeCacheStatus(), FreshnessStatus, ResearchStatus, StatusAction, StatusResult (+14 more)
...
Cohesion: 0.18
Nodes (10): API Reference, Creating a dynamic segment, Creating a layout, Creating a nested route, Creating a page, Linking between pages, Nesting layouts, Rendering with search params (+2 more)
...
Cohesion: 0.70
Nodes (4): Enough talk, show me some code already!, Motivation, Overview, You talked me into it, so what now?
...
Cohesion: 0.50
Nodes (4): Combine, Memoization, TypeScript: typing the `select` option, useQueries
...
Cohesion: 0.25
Nodes (7): How to find the correct page, Option 1 — Ask a question (recommended), Option 2 — Browse the documentation index, Option 3 — Retrieve the full documentation corpus, Page Not Found, Suggested Pages, Tips for requesting documentation
...
Cohesion: 0.06
Nodes (34): [Basic usage], [Basic usage](https://prismjs.com/#basic-usage), Compressed, [Credits], [Credits](https://prismjs.com/#credits), Detailed, [Examples], [Examples](https://prismjs.com/#examples) (+26 more)

### Community 566 - "Community 566"
Cohesion: 0.11
Nodes (18): Compressed, Detailed, Most used topics, Most used topics, Navigation Menu, Navigation Menu, Pinned Loading, Pinned Loading (+10 more)
...
Cohesion: 0.09
Nodes (22): Background, Background, Compressed, Detailed, Directories, Directories, Example, Example (+14 more)
...
Cohesion: 0.15
Nodes (12): Code Examples, Code Examples, Compressed, Creating New Widgets, Creating New Widgets, Detailed, Elementor Widgets, Elementor Widgets (+4 more)
...
Cohesion: 0.18
Nodes (10): Coordination, Default Workflow, Documentation Surface Defaults, Guardrails, Primary Objective, Reporting Format, Required Skills, Senior Technical Writer Agent (+2 more)
...
Cohesion: 0.18
Nodes (10): After, After, Before, Before, Architecture note, Beginner Technical Writing Examples, Example 1: Define term before usage, Example 2: Explain cause and effect (+2 more)
...
Cohesion: 0.29
Nodes (6): Example Rewrites, Review Questions, Source Basis, Beginner Technical Writing Reference, Best Practices, Explanation Pattern
...
Cohesion: 0.18
Nodes (10): Compressed, Detailed, Provenance, Provide feedback, Provide feedback, Saved searches, Saved searches, Summary (+2 more)

### Community 603 - "Community 603"
Cohesion: 0.18
Nodes (10): Compressed, Detailed, Provenance, Summary, Widget Class, Widget Class, Widget Methods, Widget Methods (+2 more)

### Community 604 - "Community 604"
Cohesion: 0.18
Nodes (10): Compressed, Detailed, Provenance, Rendering Different Controls, Rendering Different Controls, Rendering Methods, Rendering Methods, Summary (+2 more)

### Community 605 - "Community 605"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Usage with CDNs], [Usage with CDNs](https://prismjs.com/#basic-usage-cdn)

### Community 606 - "Community 606"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Object notation], [Object notation](https://prismjs.com/extending.html#object-notation), Provenance, Summary

### Community 607 - "Community 607"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Usage with Node], [Usage with Node](https://prismjs.com/#basic-usage-node)

### Community 608 - "Community 608"
Cohesion: 0.29
Nodes (6): Compressed, [Credits], [Credits](https://prismjs.com/#credits), Detailed, Provenance, Summary

### Community 609 - "Community 609"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Writing plugins], [Writing plugins](https://prismjs.com/extending.html#writing-plugins)

### Community 610 - "Community 610"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Full list of features], [Full list of features](https://prismjs.com/#full-list-of-features), Provenance, Summary

### Community 611 - "Community 611"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Language definitions], [Language definitions](https://prismjs.com/extending.html#language-definitions), Provenance, Summary

### Community 612 - "Community 612"
Cohesion: 0.29
Nodes (6): Compressed, [Declaring dependencies], [Declaring dependencies](https://prismjs.com/extending.html#declaring-dependencies), Detailed, Provenance, Summary

### Community 613 - "Community 613"
Cohesion: 0.29
Nodes (6): Compressed, [Dependency kinds], [Dependency kinds](https://prismjs.com/extending.html#dependency-kinds), Detailed, Provenance, Summary

### Community 614 - "Community 614"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Limitations], [Limitations](https://prismjs.com/#limitations), Provenance, Summary

### Community 615 - "Community 615"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Manual highlighting], [Manual highlighting](https://prismjs.com/#manual-highlighting), Provenance, Summary

### Community 616 - "Community 616"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Language inheritance], [Language inheritance](https://prismjs.com/#language-inheritance), Provenance, Summary

### Community 617 - "Community 617"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Token names], [Token names](https://prismjs.com/extending.html#token-names)

### Community 618 - "Community 618"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Used By], [Used By](https://prismjs.com/#used-by)

### Community 619 - "Community 619"
Cohesion: 0.29
Nodes (6): Compressed, [Dependencies], [Dependencies](https://prismjs.com/extending.html#dependencies), Detailed, Provenance, Summary

### Community 620 - "Community 620"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Greedy matching], [Greedy matching](https://prismjs.com/extending.html#greedy-matching), Provenance, Summary

### Community 621 - "Community 621"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Granular highlighting], [Granular highlighting](https://prismjs.com/extending.html#granular-highlighting), Provenance, Summary

### Community 622 - "Community 622"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Third-party language definitions], [Third-party language definitions](https://prismjs.com/#third-party-language-definitions)

### Community 623 - "Community 623"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Third-party tutorials], [Third-party tutorials](https://prismjs.com/#third-party-tutorials)

### Community 624 - "Community 624"
Cohesion: 0.29
Nodes (6): [Basic usage], [Basic usage](https://prismjs.com/#basic-usage), Compressed, Detailed, Provenance, Summary

### Community 625 - "Community 625"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Examples], [Examples](https://prismjs.com/#examples), Provenance, Summary

### Community 626 - "Community 626"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Supported languages], [Supported languages](https://prismjs.com/#supported-languages)

### Community 627 - "Community 627"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, [Resolving dependencies], [Resolving dependencies](https://prismjs.com/extending.html#resolving-dependencies), Summary

### Community 628 - "Community 628"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Helper functions], [Helper functions](https://prismjs.com/extending.html#helper-functions), Provenance, Summary

### Community 629 - "Community 629"
Cohesion: 0.29
Nodes (6): [API documentation], [API documentation](https://prismjs.com/extending.html#api-documentation), Compressed, Detailed, Provenance, Summary

### Community 630 - "Community 630"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, [Plugins], [Plugins](https://prismjs.com/#plugins), Provenance, Summary

### Community 631 - "Community 631"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [The rest property], [The rest property](https://prismjs.com/extending.html#the-rest-property)

### Community 632 - "Community 632"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Themes], [Themes](https://prismjs.com/extending.html#themes)

### Community 633 - "Community 633"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [The matching algorithm], [The matching algorithm](https://prismjs.com/extending.html#the-matching-algorithm)

### Community 634 - "Community 634"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, [Usage with Webpack, Browserify, & Other Bundlers], [Usage with Webpack, Browserify, & Other Bundlers](https://prismjs.com/#basic-usage-bundlers)

### Community 635 - "Community 635"
Cohesion: 0.29
Nodes (6): Compressed, [Creating a new language definition], [Creating a new language definition](https://prismjs.com/extending.html#creating-a-new-language-definition), Detailed, Provenance, Summary
...
Cohesion: 0.08
Nodes (41): MachineReadableArtifact, SiteCapabilities, detectDocsEngine(), getMetaGenerator(), llmsTxtCandidates(), MachineReadableResult, probeLlmsTxt(), probeRouteMarkdown() (+33 more)

### Community 638 - "Community 638"
Cohesion: 0.10
Nodes (21): Advanced Configuration, Code Groups, Colored Diffs in Code Blocks, Custom anchors, Detailed, Emoji :tada:, Errors and Warnings in Code Blocks, Focus in Code Blocks (+13 more)
...
Cohesion: 0.12
Nodes (16): Arrays, Arrays, Compressed, Detailed, Enums, Enums, Provenance, Summary (+8 more)
...
Cohesion: 0.07
Nodes (28): Agent web fetch vs Bonsai, Antigravity, Claude Code, Codex, Cursor, Mistral Vibe, More agents, Results (+20 more)
...
Cohesion: 0.08
Nodes (38): Fixture, fixtures, captureFixture(), CdpPage, ExtractionResult, CONTENT_SELECTORS, fetchDeveloperPage(), salesforceDeveloper (+30 more)

### Community 651 - "Community 651"
Cohesion: 0.14
Nodes (13): API Styles {#api-styles}, Composition API {#composition-api}, Compressed, Introduction {#introduction}, Options API {#options-api}, Pick Your Learning Path {#pick-your-learning-path}, Provenance, Single-File Components {#single-file-components} (+5 more)
...
Cohesion: 0.20
Nodes (9): 1. Fetch and cache a page, 2. Run it again — straight from cache, 3. See what's cached, without fetching, 4. Import a note of your own, 5. List what you have cached, Getting Started, Install, Requirements (+1 more)

### Community 654 - "Community 654"
Cohesion: 0.18
Nodes (10): Compressed, Detailed, Examples of passing reactive dependencies, Examples of passing reactive dependencies, Passing a dependency array, Passing a dependency array, Pitfall, Pitfall (+2 more)

### Community 655 - "Community 655"
Cohesion: 0.18
Nodes (10): Compressed, Deep Dive, Deep Dive, Detailed, Fetching data with Effects, Fetching data with Effects, Provenance, Summary (+2 more)

### Community 656 - "Community 656"
Cohesion: 0.18
Nodes (10): Compressed, Connecting to a chat server, Connecting to a chat server, Detailed, Examples of connecting to an external system, Examples of connecting to an external system, Note, Note (+2 more)

### Community 657 - "Community 657"
Cohesion: 0.18
Nodes (10): `bigint`, `bigint`, Compressed, Detailed, Less Common Primitives, Less Common Primitives, Provenance, Summary (+2 more)

### Community 658 - "Community 658"
Cohesion: 0.18
Nodes (10): Compressed, Custom `useChatRoom` Hook, Custom `useChatRoom` Hook, Detailed, Examples of wrapping Effects in custom Hooks, Examples of wrapping Effects in custom Hooks, Provenance, Summary (+2 more)

### Community 659 - "Community 659"
Cohesion: 0.20
Nodes (9): Caveats, Compressed, Detailed, Parameters, Provenance, Reference, Returns, Summary (+1 more)
...
Cohesion: 0.29
Nodes (6): Introduction, Safe by default, What it does, Where to next, Why a cache?, Why the name?

### Community 663 - "Community 663"
Cohesion: 0.29
Nodes (6): Configuration, File locations, Flags, Keys, Managing values, Precedence

### Community 664 - "Community 664"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, My Effect runs twice when the component mounts, My Effect runs twice when the component mounts, Provenance, Summary

### Community 665 - "Community 665"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Type Annotations on Variables, Type Annotations on Variables

### Community 666 - "Community 666"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, `noImplicitAny`, `noImplicitAny`, Provenance, Summary

### Community 667 - "Community 667"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Displaying different content on the server and the client, Displaying different content on the server and the client, Provenance, Summary

### Community 668 - "Community 668"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Type Assertions, Type Assertions

### Community 669 - "Community 669"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Optional Properties, Optional Properties, Provenance, Summary

### Community 670 - "Community 670"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, The primitives: `string`, `number`, and `boolean`, The primitives: `string`, `number`, and `boolean`

### Community 671 - "Community 671"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Non-null Assertion Operator (Postfix `!`), Non-null Assertion Operator (Postfix `!`), Provenance, Summary

### Community 672 - "Community 672"
Cohesion: 0.29
Nodes (6): `any`, `any`, Compressed, Detailed, Provenance, Summary

### Community 673 - "Community 673"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, `strictNullChecks` on, `strictNullChecks` on, Summary

### Community 674 - "Community 674"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Usage, Usage

### Community 675 - "Community 675"
Cohesion: 0.29
Nodes (6): Arrays, Arrays, Compressed, Detailed, Provenance, Summary

### Community 676 - "Community 676"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Working with Union Types, Working with Union Types

### Community 677 - "Community 677"
Cohesion: 0.29
Nodes (6): Compressed, Connecting to an external system, Connecting to an external system, Detailed, Provenance, Summary

### Community 678 - "Community 678"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Updating state based on previous state from an Effect, Updating state based on previous state from an Effect

### Community 679 - "Community 679"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Union Types, Union Types
...
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Literal Types, Literal Types, Provenance, Summary

### Community 682 - "Community 682"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Removing unnecessary function dependencies, Removing unnecessary function dependencies, Summary

### Community 683 - "Community 683"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Type Aliases, Type Aliases

### Community 684 - "Community 684"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, `strictNullChecks` off, `strictNullChecks` off, Summary

### Community 685 - "Community 685"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Differences Between Type Aliases and Interfaces, Differences Between Type Aliases and Interfaces, Provenance, Summary

### Community 686 - "Community 686"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Literal Inference, Literal Inference, Provenance, Summary

### Community 687 - "Community 687"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, My cleanup logic runs even though my component didn’t unmount, My cleanup logic runs even though my component didn’t unmount, Provenance, Summary

### Community 688 - "Community 688"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, My Effect does something visual, and I see a flicker before it runs, My Effect does something visual, and I see a flicker before it runs, Provenance, Summary

### Community 689 - "Community 689"
Cohesion: 0.29
Nodes (6): Compressed, Controlling a non-React widget, Controlling a non-React widget, Detailed, Provenance, Summary

### Community 690 - "Community 690"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Enums, Enums, Provenance, Summary

### Community 691 - "Community 691"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, My Effect runs after every re-render, My Effect runs after every re-render, Provenance, Summary

### Community 692 - "Community 692"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Object Types, Object Types, Provenance, Summary
...
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Parameter Type Annotations, Parameter Type Annotations, Provenance, Summary

### Community 695 - "Community 695"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Interfaces, Interfaces, Provenance, Summary

### Community 696 - "Community 696"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Reading the latest props and state from an Effect, Reading the latest props and state from an Effect, Summary

### Community 697 - "Community 697"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, `null` and `undefined`, `null` and `undefined`, Provenance, Summary

### Community 698 - "Community 698"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, My Effect keeps re-running in an infinite cycle, My Effect keeps re-running in an infinite cycle, Provenance, Summary

### Community 699 - "Community 699"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Specifying reactive dependencies, Specifying reactive dependencies, Summary

### Community 700 - "Community 700"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Functions, Functions, Provenance, Summary

### Community 701 - "Community 701"
Cohesion: 0.29
Nodes (6): Compressed, Defining a Union Type, Defining a Union Type, Detailed, Provenance, Summary

### Community 702 - "Community 702"
Cohesion: 0.29
Nodes (6): Anonymous Functions, Anonymous Functions, Compressed, Detailed, Provenance, Summary

### Community 703 - "Community 703"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Removing unnecessary object dependencies, Removing unnecessary object dependencies, Summary

### Community 704 - "Community 704"
Cohesion: 0.33
Nodes (6): My cleanup logic runs even though my component didn’t unmount, My Effect does something visual, and I see a flicker before it runs, My Effect keeps re-running in an infinite cycle, My Effect runs after every re-render, My Effect runs twice when the component mounts, Troubleshooting
...
Cohesion: 0.40
Nodes (5): Anonymous Functions, Functions, Functions Which Return Promises, Parameter Type Annotations, Return Type Annotations
...
Cohesion: 0.40
Nodes (5): Caveats, Parameters, Reference, Returns, `useEffect(setup, dependencies?)`

### Community 713 - "Community 713"
Cohesion: 0.50
Nodes (4): Non-null Assertion Operator (Postfix `!`), `null` and `undefined`, `strictNullChecks` off, `strictNullChecks` on
...
Cohesion: 0.10
Nodes (21): Advanced Configuration, Code Groups, Colored Diffs in Code Blocks, Custom anchors, Emoji :tada:, Errors and Warnings in Code Blocks, Focus in Code Blocks, Frontmatter (+13 more)

### Community 716 - "Community 716"
Cohesion: 0.67
Nodes (3): `bigint`, Less Common Primitives, `symbol`
...
Cohesion: 0.67
Nodes (3): Defining a Union Type, Union Types, Working with Union Types
...
Cohesion: 0.67
Nodes (3): Connecting to a chat server, Examples of connecting to an external system, Note
...
Cohesion: 0.07
Nodes (26): Avoiding Timeouts[​], Avoiding Timeouts[​](https://oclif.io/docs/commands#avoiding-timeouts "Direct link to Avoiding Timeouts"), Command Methods[​], Command Methods[​](https://oclif.io/docs/commands#command-methods "Direct link to Command Methods"), Compressed, Detailed, Other Command Options[​], Other Command Options[​](https://oclif.io/docs/commands#other-command-options "Direct link to Other Command Options") (+18 more)

### Community 734 - "Community 734"
Cohesion: 0.12
Nodes (16): Best Practice References, Dash And Structure Audit, Detection Reality, Editing Checklist, Example Rewrite, Human Prose Editing, Local Examples, Paragraph-Level Method (+8 more)

### Community 735 - "Community 735"
Cohesion: 0.13
Nodes (14): Anti-AI Writing, Best Practice References, Boundary With `human-prose-editing`, Goal, Local Examples, Longer Example, Prefer These Rewrites, Quick Pass Checklist (+6 more)
...
Cohesion: 0.18
Nodes (10): After, After, After, Before, Before, Before, Anti-AI Writing Examples, Example 1: Remove throat-clearing (+2 more)
...
Cohesion: 0.14
Nodes (14): Deploy App, Detailed, How skills work, Installing skills from GitHub, Learn more, Migrating rules and commands to skills, Nested skill directories, Optional directories (+6 more)
...
Cohesion: 0.29
Nodes (6): Example Rewrites, Source Basis, Anti-AI Writing Reference, Rewrite Moves, Sentence Audit, What To Cut
...
Cohesion: 0.33
Nodes (5): Review Questions, Source Basis, Human Prose Editing Reference, Paragraph Method, Rewrite Example

### Community 746 - "Community 746"
Cohesion: 0.40
Nodes (4): But speed matters too, Isn't this just like memory?, Memory remembers; Bonsai reads, The cache is a speed benefit, not the mission
...
Cohesion: 0.17
Nodes (11): Bundled skills, Bundled skills, Compressed, Detailed, Evaluate and iterate on a skill, Generate visual output, Provenance, Run and verify your app (+3 more)

### Community 760 - "Community 760"
Cohesion: 0.18
Nodes (10): Available string substitutions, Available string substitutions, Compressed, Detailed, Frontmatter reference, Frontmatter reference, How a skill gets its command name, How a skill gets its command name (+2 more)

### Community 761 - "Community 761"
Cohesion: 0.20
Nodes (9): Compressed, Disabling automatic invocation, How skills work, Including scripts in skills, Nested skill directories, React component patterns, Skill directories, SKILL.md file format (+1 more)

### Community 762 - "Community 762"
Cohesion: 0.20
Nodes (10): Deploy App, Installing skills from GitHub, Learn more, Migrating rules and commands to skills, Optional directories, Pre-deployment Validation, Provenance, Sitemap (+2 more)

### Community 763 - "Community 763"
Cohesion: 0.20
Nodes (10): Add supporting files, Available string substitutions, Configure skills, Control who invokes a skill, Frontmatter reference, How a skill gets its command name, Pass arguments to skills, Pre-approve tools for a skill (+2 more)
...
Cohesion: 0.20
Nodes (10): Available tools, Conditional rules with hooks, Control subagent capabilities, Disable specific subagents, Enable persistent memory, Permission modes, Persistent memory tips, Preload skills into subagents (+2 more)
...
Cohesion: 0.22
Nodes (9): Choose a model, Choose the subagent scope, Configure subagents, Define hooks for subagents, Hooks in subagent frontmatter, Project-level hooks for subagent events, Supported frontmatter fields, Use the /agents command (+1 more)
...
Cohesion: 0.22
Nodes (8): Compressed, Detailed, Example: Research skill using Explore agent, Example: Research skill using Explore agent, Provenance, Run skills in a subagent, Run skills in a subagent, Summary

### Community 770 - "Community 770"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Skill content lifecycle, Skill content lifecycle, Summary

### Community 771 - "Community 771"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Generate visual output, Generate visual output, Provenance, Summary

### Community 772 - "Community 772"
Cohesion: 0.29
Nodes (6): Bundled skills, Bundled skills, Compressed, Detailed, Provenance, Summary

### Community 773 - "Community 773"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Skill not triggering, Skill not triggering, Summary

### Community 774 - "Community 774"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Run and verify your app, Run and verify your app, Summary

### Community 775 - "Community 775"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Override skill visibility from settings, Override skill visibility from settings, Provenance, Summary

### Community 776 - "Community 776"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Skill descriptions are cut short, Skill descriptions are cut short, Summary

### Community 777 - "Community 777"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Evaluate and iterate on a skill, Evaluate and iterate on a skill, Provenance, Summary

### Community 778 - "Community 778"
Cohesion: 0.29
Nodes (6): Compressed, Create your first skill, Create your first skill, Detailed, Provenance, Summary

### Community 779 - "Community 779"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Pass arguments to skills, Pass arguments to skills, Provenance, Summary

### Community 780 - "Community 780"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Types of skill content, Types of skill content

### Community 781 - "Community 781"
Cohesion: 0.29
Nodes (6): Compressed, Control who invokes a skill, Control who invokes a skill, Detailed, Provenance, Summary

### Community 782 - "Community 782"
Cohesion: 0.29
Nodes (6): Advanced patterns, Advanced patterns, Compressed, Detailed, Provenance, Summary

### Community 783 - "Community 783"
Cohesion: 0.29
Nodes (6): Add supporting files, Add supporting files, Compressed, Detailed, Provenance, Summary

### Community 784 - "Community 784"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Run evals with skill-creator, Run evals with skill-creator, Summary

### Community 785 - "Community 785"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Pre-approve tools for a skill, Pre-approve tools for a skill, Provenance, Summary

### Community 786 - "Community 786"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Getting started, Getting started, Provenance, Summary

### Community 787 - "Community 787"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Restrict Claude’s skill access, Restrict Claude’s skill access, Summary

### Community 788 - "Community 788"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Inject dynamic context, Inject dynamic context, Provenance, Summary

### Community 789 - "Community 789"
Cohesion: 0.29
Nodes (6): Compressed, Configure skills, Configure skills, Detailed, Provenance, Summary
...
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Skill triggers too often, Skill triggers too often, Summary

### Community 792 - "Community 792"
Cohesion: 0.33
Nodes (6): Advanced patterns, Example: Research skill using Explore agent, Inject dynamic context, Override skill visibility from settings, Restrict Claude’s skill access, Run skills in a subagent
...
Cohesion: 0.33
Nodes (6): Automatic discovery from parent and nested directories, Create your first skill, Getting started, Live change detection, Skills from additional directories, Where skills live
...
Cohesion: 0.40
Nodes (5): Actionable, Portable, Progressive, Version-controlled, What are skills?
...
Cohesion: 0.40
Nodes (5): Frontmatter fields, Instructions, My Skill, Scoping a skill to specific files, When to Use
...
Cohesion: 0.50
Nodes (4): Skill descriptions are cut short, Skill not triggering, Skill triggers too often, Troubleshooting
...
Cohesion: 0.13
Nodes (14): Compressed, Customizing the name color, Customizing the name color, Detailed, Features Section, Features Section, Hero Section, Hero Section (+6 more)

### Community 805 - "Community 805"
Cohesion: 0.67
Nodes (3): Disabling automatic invocation, Including scripts in skills, React component patterns

### Community 806 - "Community 806"
Cohesion: 0.67
Nodes (3): Evaluate and iterate on a skill, Generate visual output, Run evals with skill-creator

### Community 807 - "Community 807"
Cohesion: 0.12
Nodes (17): Analytics, Arguments and flags, Configuration, Distribution, Documentation, Environment variables, Errors, Future-proofing (+9 more)
...
Cohesion: 0.12
Nodes (16): ResearchInspect, LIST_LABELS, LISTABLE_ARTIFACT_TYPES, ResearchList, limitFlag(), closestMatch(), levenshtein(), maxFuzzyDistance() (+8 more)
...
Cohesion: 0.18
Nodes (10): Compressed, Detailed, Foreword, Foreword, Further reading, Further reading, Introduction, Introduction (+2 more)
...
Cohesion: 0.22
Nodes (8): Compressed, Detailed, OAuth 2.0, OAuth 2.0, Provenance, Settings, Settings, Summary
...
Cohesion: 0.22
Nodes (8): bin/run.js `catch` handler[​], bin/run.js `catch` handler[​](https://oclif.io/docs/error_handling#binrunjs-catch-handler "Direct link to binrunjs-catch-handler"), Compressed, Detailed, Error Handling in the `catch` method[​], Error Handling in the `catch` method[​](https://oclif.io/docs/error_handling#error-handling-in-the-catch-method "Direct link to error-handling-in-the-catch-method"), Provenance, Summary
...
Cohesion: 0.13
Nodes (26): fakeCapture(), fakeExtraction(), fakeFetchResult(), mocks, seedCachedArtifact(), defaultFetcher(), deriveCacheKey(), assertOk() (+18 more)
...
Cohesion: 0.25
Nodes (7): Changeset Release Writing, Checklist, Example, Repo Release Model, When Not to Use, When to Use, Writing Rules
...
Cohesion: 0.18
Nodes (11): base, description, Example: Adding a favicon, Example: Adding Google Fonts, Example: Registering a service worker, Example: Using Google Analytics, head, lang (+3 more)
...
Cohesion: 0.22
Nodes (9): assetsDir, Build, cacheDir, ignoreDeadLinks, metaChunk&#x20;, mpa&#x20;, outDir, srcDir (+1 more)
...
Cohesion: 0.07
Nodes (39): __dirname, pkg, rawArgv, req, result, bareUrlInput(), buildCommandNotFoundDetails(), emitJsonError() (+31 more)

### Community 955 - "Community 955"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Sitemaps & Cross Submits, Sitemaps & Cross Submits, Summary

### Community 956 - "Community 956"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, XML tag definitions, XML tag definitions

### Community 957 - "Community 957"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Submitting your Sitemap via the search engine's submission interface, Submitting your Sitemap via the search engine's submission interface, Summary

### Community 958 - "Community 958"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Syndication feed, Syndication feed

### Community 959 - "Community 959"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Specifying the Sitemap location in your robots.txt file, Specifying the Sitemap location in your robots.txt file, Summary

### Community 960 - "Community 960"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Excluding content, Excluding content, Provenance, Summary

### Community 961 - "Community 961"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Text file, Text file

### Community 962 - "Community 962"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Entity escaping, Entity escaping, Provenance, Summary

### Community 963 - "Community 963"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Validating your Sitemap, Validating your Sitemap

### Community 964 - "Community 964"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Submitting your Sitemap via an HTTP request, Submitting your Sitemap via an HTTP request, Summary
...
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Saying (just) enough, Saying (just) enough, Summary

### Community 967 - "Community 967"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Sample XML Sitemap Index, Sample XML Sitemap Index, Summary

### Community 968 - "Community 968"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Extending the Sitemaps protocol, Extending the Sitemaps protocol, Provenance, Summary

### Community 969 - "Community 969"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, Using Sitemap index files (to group multiple sitemap files), Using Sitemap index files (to group multiple sitemap files)

### Community 970 - "Community 970"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Sitemap file location, Sitemap file location, Summary

### Community 971 - "Community 971"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Informing search engine crawlers, Informing search engine crawlers, Provenance, Summary

### Community 972 - "Community 972"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Other Sitemap formats, Other Sitemap formats, Provenance, Summary

### Community 973 - "Community 973"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Sitemap Index XML Tag Definitions, Sitemap Index XML Tag Definitions, Summary

### Community 974 - "Community 974"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Sitemaps XML format, Sitemaps XML format, Summary

### Community 975 - "Community 975"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Sample XML Sitemap, Sample XML Sitemap, Summary

### Community 976 - "Community 976"
Cohesion: 0.38
Nodes (6): Compressed, Detailed, Provenance, Summary, test note, test note
...
Cohesion: 0.29
Nodes (6): Compressed, Conversation as the norm, Conversation as the norm, Detailed, Provenance, Summary

### Community 980 - "Community 980"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Summary, The Basics, The Basics

### Community 981 - "Community 981"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Naming, Naming, Provenance, Summary

### Community 982 - "Community 982"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Introduction, Introduction, Provenance, Summary
...
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Empathy, Empathy, Provenance, Summary

### Community 985 - "Community 985"
Cohesion: 0.29
Nodes (6): Analytics, Analytics, Compressed, Detailed, Provenance, Summary

### Community 986 - "Community 986"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Interactivity, Interactivity, Provenance, Summary

### Community 987 - "Community 987"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Errors, Errors, Provenance, Summary

### Community 988 - "Community 988"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Philosophy, Philosophy, Provenance, Summary

### Community 989 - "Community 989"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Robustness, Robustness, Summary

### Community 990 - "Community 990"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Help, Help, Provenance, Summary

### Community 991 - "Community 991"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Future-proofing, Future-proofing, Provenance, Summary

### Community 992 - "Community 992"
Cohesion: 0.29
Nodes (6): Arguments and flags, Arguments and flags, Compressed, Detailed, Provenance, Summary

### Community 993 - "Community 993"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Output, Output, Provenance, Summary

### Community 994 - "Community 994"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Subcommands, Subcommands, Summary

### Community 995 - "Community 995"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Simple parts that work together, Simple parts that work together, Summary

### Community 996 - "Community 996"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Foreword, Foreword, Provenance, Summary

### Community 997 - "Community 997"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Human-first design, Human-first design, Provenance, Summary

### Community 998 - "Community 998"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Guidelines, Guidelines, Provenance, Summary

### Community 999 - "Community 999"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Distribution, Distribution, Provenance, Summary

### Community 1000 - "Community 1000"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Further reading, Further reading, Provenance, Summary

### Community 1001 - "Community 1001"
Cohesion: 0.29
Nodes (6): Compressed, Consistency across programs, Consistency across programs, Detailed, Provenance, Summary

### Community 1002 - "Community 1002"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Provenance, Signals and control characters, Signals and control characters, Summary

### Community 1003 - "Community 1003"
Cohesion: 0.29
Nodes (6): Compressed, Detailed, Documentation, Documentation, Provenance, Summary

### Community 1004 - "Community 1004"
Cohesion: 0.29
Nodes (6): Chaos, Chaos, Compressed, Detailed, Provenance, Summary
...
Cohesion: 0.07
Nodes (24): createFixtures(), networkEnabled(), CLI, createHarness(), DIST_COMMANDS, ensureBuilt(), REPO_ROOT, expectNonIntegerLimitInvalid() (+16 more)

### Community 1007 - "Community 1007"
Cohesion: 0.22
Nodes (8): Compressed, Detailed, IDF information theoretic interpretation, IDF information theoretic interpretation, Provenance, Summary, The ranking function, The ranking function
...
Cohesion: 0.33
Nodes (5): Changeset Requirement, Mandatory Follow-Up, Verification, When This Is Not Required, When This Is Required
...
Cohesion: 0.40
Nodes (4): Changelog generator, Changesets, Common Commands, Snapshot Releases

### Community 1018 - "Community 1018"
Cohesion: 0.50
Nodes (4): lint-staged, scripts/**/*.ts, src/**/*.ts, tests/**/*.ts
...
## Knowledge Gaps
- **7111 isolated node(s):** `$schema`, `changelog`, `commit`, `fixed`, `linked` (+7106 more)
...
- **What connects `$schema`, `changelog`, `commit` to the rest of the system?**
  _7111 weakly-connected nodes found - possible documentation gaps or missing edges._
