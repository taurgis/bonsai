...
As a first example of ownership, we’ll look at the scope of some variables. A _scope_ is the range within a program for which an item is valid. Take the following variable:
...
[Listing 4-1](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html#listing-4-1): A variable and the scope in which it is valid
...
We’ll concentrate on the parts of `String` that relate to ownership. These aspects also apply to other complex data types, whether they are provided by the standard library or created by you. We’ll discuss non-ownership aspects of `String` in [Chapter 8](https://doc.rust-lang.org/book/ch08-02-strings.html).
...
[Listing 4-2](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html#listing-4-2): Assigning the integer value of variable `x` to `y`
...
data (hello) grayed out because it cannot be accessed anymore.](img/trpl04-05.svg)
...
[Listing 4-3](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html#listing-4-3): Functions with ownership and scope annotated
...
[Listing 4-4](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html#listing-4-4): Transferring ownership of return values
...
[Listing 4-5](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html#listing-4-5): Returning ownership of parameters
