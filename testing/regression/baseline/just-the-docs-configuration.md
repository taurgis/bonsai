...
1.  [Site logo](https://just-the-docs.com/docs/configuration/#site-logo)
2.  [Site favicon](https://just-the-docs.com/docs/configuration/#site-favicon)
3.  [Search](https://just-the-docs.com/docs/configuration/#search)
4.  [Mermaid Diagrams](https://just-the-docs.com/docs/configuration/#mermaid-diagrams)
5.  [Aux links](https://just-the-docs.com/docs/configuration/#aux-links)
6.  [Navigation sidebar](https://just-the-docs.com/docs/configuration/#navigation-sidebar)
7.  [Heading anchor links](https://just-the-docs.com/docs/configuration/#heading-anchor-links)
8.  [External navigation links](https://just-the-docs.com/docs/configuration/#external-navigation-links)
9.  [Footer content](https://just-the-docs.com/docs/configuration/#footer-content)
10.  [Color scheme](https://just-the-docs.com/docs/configuration/#color-scheme)
11.  [Callouts](https://just-the-docs.com/docs/configuration/#callouts)
12.  [Google Analytics](https://just-the-docs.com/docs/configuration/#google-analytics)
13.  [Document collections](https://just-the-docs.com/docs/configuration/#document-collections)
...
See [the Code documentation](https://just-the-docs.com/docs/ui-components/code/#mermaid-diagram-code-blocks) for more configuration options and information.
...
External links can be added to the navigation through the `nav_external_links` option. See [Navigation Structure](https://just-the-docs.com/docs/navigation/main/external/) for more details.
...
See [Customization](https://just-the-docs.com/docs/customization/) for more information.
...
See [Callouts](https://just-the-docs.com/docs/ui-components/callouts/) for more information. The colors used in the theme are further described in [Color Utilities](https://just-the-docs.com/docs/utilities/color/).
...
New (v0.4.0) Including `nav_fold: true` in a collection configuration _folds_ that collection: an expander symbol appears next to the collection name, and clicking it displays/hides the links to the top-level pages of the collection.[1](https://just-the-docs.com/docs/configuration/#fn:js-disabled)
