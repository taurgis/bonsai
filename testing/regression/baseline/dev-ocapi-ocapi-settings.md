...
| `clients` | [[Client](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/ocapisettings.html#client-document)] | N/A         | Array of client-specific permission documents.                                                                                                                                                                                        |
...
| Property           | Type                                                                                                         | Constraints                    | Description                                                                                                                                                                                   |
| ------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `allowed_origins`  | [String]                                                                                                     | N/A                            | Array of allowed origins used in [CORS](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/cors.html) requests.                                                                        |
...
| `resources`        | [[Resource](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/ocapisettings.html#resource-document)] | N/A                            | Array of resource-specific permission documents.                                                                                                                                              |
...
| `config`                       | Map<String,String>                                                                                                   | N/A                            | Map that determines which values are returned for some special response document properties. You control this map by configuring reserved key/value pairs. For more information, see [Customization](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/ocapisettings.html#customization).                                                                                                                                                                                             |
...
| `read_attributes`              | String                                                                                                               | N/A                            | String that controls which properties are included in the response document. The configuration value must be specified using [property selection](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/propertyselection.html) syntax.                                                                                                                                                                                                                                                   |
...
| `version_range`                | [[VersionRange](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/ocapisettings.html#versionrange-document)] | N/A                            | Array of VersionRange documents granting permissions only to a subset of OCAPI versions.                                                                                                                                                                                                                                                                                                                                                                                                      |
| `write_attributes`             | String                                                                                                               | N/A                            | String that controls which properties can be included in the request document. The configuration value must be specified using [property selection](/docs/commerce/b2c-commerce/references/b2c-commerce-ocapi/propertyselection.html) syntax.                                                                                                                                                                                                                                                 |
