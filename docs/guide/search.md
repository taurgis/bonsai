...
synthesis is stored. See [Importing Synthesis](/guide/importing-synthesis) for
...
`--domain` searches a documentation site through its [site module](/guide/site-modules).
