...
description: "Reviews CI/CD, packaging, and publish automation changes. Use before changing workflows, release scripts, package metadata, or publish behavior."
model: sonnet
...
Source: `.github/agents/senior-release-manager.agent.md`
Display name alias: `Senior Release Manager`
