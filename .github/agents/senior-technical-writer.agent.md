...
description: Audits, revises, and writes documentation across a codebase,
  including inline docstrings, generated docs, READMEs, onboarding material, and
  CLI copy.
model: Auto
tools:
  - read
...
skills:
  ...
  - anti-ai-writing
  - human-prose-editing
argument-hint: What documentation surface or change should be updated or audited?
metadata:
  version: 1.0.0
---
...
- For audience-aware explanations that stay correct for experts while remaining readable for newcomers, use the [beginner-technical-writing](../skills/beginner-technical-writing/SKILL.md) skill.
