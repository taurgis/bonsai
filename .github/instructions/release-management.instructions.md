---
description: Require Senior Release Manager for CI/CD, Changesets, packaging,
  and release automation changes
applyTo: .github/workflows/**/*.{yml,yaml},.changeset/config.json,package.json,pnpm-lock.yaml,.github/agents/senior-release-manager.agent.md
metadata:
  version: 1.0.2
---
