...
source_url: https://nodejs.org/api/fs.html#fsrmsyncpath-options
source_urls:
  - https://nodejs.org/api/fs.html#fsrmsyncpath-options
normalized_url: https://nodejs.org/api/fs.html
cache_key: 4bad305df53a3088e3ea977c674707f28b8390eb6f5dd9d5f632c0a948dad1d2
topic: Node fs Stats
tags:
  - node
  - fs
...
content_hash: d89a66788d273db30d920f87ea7631060e4e7810b423a7529fc8aeecf6962409
token_estimate:
  compressed: 313
  detailed: 313
status: active
...
section_anchor: fsrmsyncpath-options
section_heading_path: File system > Synchronous API > `fs.rmSync(path[, options])`
---

## Summary

File system > Synchronous API > `fs.rmSync(path[, options])`
...
Section "File system > Synchronous API > `fs.rmSync(path[, options])`" of https://nodejs.org/api/fs.html (parent e592a8e6818242987d359207b9042a5ad8f72a785792e1b5fcaa69c82fb3077a)