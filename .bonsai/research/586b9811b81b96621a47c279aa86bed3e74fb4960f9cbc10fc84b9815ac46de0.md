...
source_url: https://vitepress.dev/guide/extending-default-theme
source_urls:
  - https://vitepress.dev/guide/extending-default-theme
  - https://vitepress.dev/guide/extending-default-theme.md
normalized_url: https://vitepress.dev/guide/extending-default-theme
cache_key: 586b9811b81b96621a47c279aa86bed3e74fb4960f9cbc10fc84b9815ac46de0
topic: 
tags:
  - theme
  - default
...
tier: standard
ttl: 
fetched_at: 2026-06-25T15:43:53.593Z
validated_at: 2026-06-25T15:43:53.593Z
stale_after: 2026-07-25T15:43:53.593Z
capture_method: route_markdown
extraction_status: extracted
extraction_confidence: high
quality_notes:
  - captured from public Markdown/MDX source: https://vitepress.dev/guide/extending-default-theme.md
  - auto-generated tags via keyword extraction
supplied_at: 
supplied_by: 
etag: "8f5c337f4d3939d596ee5a9abdc06111-ssl-df"
last_modified: 
content_hash: 9558f7b88c1d5eff4e40a7745a8e22eab01cf56f6bd5c4aefac4c28c9966937f
token_estimate:
  compressed: 1520
  detailed: 1780
status: active
...
docs_framework: 
source_doc_url: https://vitepress.dev/guide/extending-default-theme.md
...
However, there are a number of cases where configuration alone won't be enough.
...
VitePress uses [Inter] as the default font, and will include the fonts in the build output.
...
::: warning If you are using optional components like the [Team Page] components, make sure to also import them from `vitepress/theme-without-fonts`! :::

If your font is a local file referenced via `@font-face`, it will be processed as an asset and included under `.vitepress/dist/assets` with hashed filename.
...
The default theme's `<Layout/>` component has a few slots that can be used to inject content at certain locations of the page.
...
You can extend the default theme to provide a custom transition when the color mode is toggled.
...
To know the exact name of the component refer [our source code].
...
Fetched from https://vitepress.dev/guide/extending-default-theme on 2026-06-25T15:43:53.593Z