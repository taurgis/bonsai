...
source_url: https://vitepress.dev/guide/markdown
source_urls:
  - https://vitepress.dev/guide/markdown
  - https://vitepress.dev/guide/markdown.md
normalized_url: https://vitepress.dev/guide/markdown
cache_key: f65604907370ecd66cf995d70a6d890a795a6f362994f6b294b719be391ff282
topic: 
tags:
  - code
  - line
...
tier: standard
ttl: 
fetched_at: 2026-06-25T16:29:04.114Z
validated_at: 2026-06-25T16:29:04.114Z
stale_after: 2026-07-25T16:29:04.114Z
capture_method: route_markdown
extraction_status: extracted
extraction_confidence: high
quality_notes:
  - captured from public Markdown/MDX source: https://vitepress.dev/guide/markdown.md
  - auto-generated tags via keyword extraction
supplied_at: 
supplied_by: 
etag: "c0a9077e6beb2debd92a5cd1cade97a0-ssl-df"
last_modified: 
content_hash: 92d3952970c161be0335d5d34ac51162f9a49a2cc3a952dde666638d86e2df50
token_estimate:
  compressed: 4725
  detailed: 5473
status: active
...
docs_framework: 
source_doc_url: https://vitepress.dev/guide/markdown.md
...
[foo heading] <!-- anchors user to a heading in the foo index file -->
[bar - three] <!-- you can omit extension -->
[bar - three] <!-- you can append .md -->
[bar - four] <!-- or you can append .html -->
```
...
You can add additional attributes to the custom containers.
...
`vp-raw` class can be directly used on elements too.
...
VitePress also supports [GitHub-flavored alerts] to render as callouts.
...
VitePress uses [Shiki] to highlight language syntax in Markdown code blocks, using coloured text.
...
You may also customize syntax highlight theme, configure language aliases, and set custom language labels in app config.
...
You can also customize the starting line number by adding `=` after `:line-numbers`.
...
::: tip The value of `@` corresponds to the source root.
...
::: tip You can also prefix the markdown path with `@`, and it will act as the source root.
...
::: warning Note that this does not throw errors if your file is not present.

Instead of VS Code regions, you can also use header anchors to include a specific section of the file.
...
Here, `my-base-section` is the generated id of the heading element.
...
Fetched from https://vitepress.dev/guide/markdown on 2026-06-25T16:29:04.114Z