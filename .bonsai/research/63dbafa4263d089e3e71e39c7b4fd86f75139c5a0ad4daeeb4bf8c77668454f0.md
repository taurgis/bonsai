...
source_url: https://nodejs.org/api/fs.html#fsfstatsyncfd-options
source_urls:
  - https://nodejs.org/api/fs.html#fsfstatsyncfd-options
normalized_url: https://nodejs.org/api/fs.html
cache_key: 63dbafa4263d089e3e71e39c7b4fd86f75139c5a0ad4daeeb4bf8c77668454f0
topic: Node fs Stats
tags:
  - node
  - fs
...
content_hash: 4baf634088d0d34d591528ec9b351b415d81240753c1d7d0051804737a4fccbf
token_estimate:
  compressed: 146
  detailed: 146
status: active
...
section_anchor: fsfstatsyncfd-options
section_heading_path: File system > Synchronous API > `fs.fstatSync(fd[, options])`
---

## Summary

File system > Synchronous API > `fs.fstatSync(fd[, options])`
...
Section "File system > Synchronous API > `fs.fstatSync(fd[, options])`" of https://nodejs.org/api/fs.html (parent e592a8e6818242987d359207b9042a5ad8f72a785792e1b5fcaa69c82fb3077a)