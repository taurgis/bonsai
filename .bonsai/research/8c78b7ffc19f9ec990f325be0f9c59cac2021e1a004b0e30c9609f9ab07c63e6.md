...
source_url: https://nodejs.org/api/fs.html#fsreadsyncfd-buffer-offset-length-position
source_urls:
  - https://nodejs.org/api/fs.html#fsreadsyncfd-buffer-offset-length-position
normalized_url: https://nodejs.org/api/fs.html
cache_key: 8c78b7ffc19f9ec990f325be0f9c59cac2021e1a004b0e30c9609f9ab07c63e6
topic: Node fs Stats
tags:
  - node
  - fs
...
content_hash: 753f7fa4eb256a6f1b3fe968501050d8fd4f7d8b0c60a732264c3941d417ea97
token_estimate:
  compressed: 181
  detailed: 181
status: active
...
section_anchor: fsreadsyncfd-buffer-offset-length-position
section_heading_path: File system > Synchronous API > `fs.readSync(fd, buffer, offset, length[, position])`
---

## Summary

File system > Synchronous API > `fs.readSync(fd, buffer, offset, length[, position])`
...
Section "File system > Synchronous API > `fs.readSync(fd, buffer, offset, length[, position])`" of https://nodejs.org/api/fs.html (parent e592a8e6818242987d359207b9042a5ad8f72a785792e1b5fcaa69c82fb3077a)