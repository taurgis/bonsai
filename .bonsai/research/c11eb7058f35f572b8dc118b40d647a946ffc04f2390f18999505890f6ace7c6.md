...
normalized_url: https://simonwillison.net/2025/Jun/16/the-lethal-trifecta/
cache_key: c11eb7058f35f572b8dc118b40d647a946ffc04f2390f18999505890f6ace7c6
topic: indirect prompt injection false positive check
tags:
  - security
  - prompt-injection
format_available:
...
tier: standard
ttl: 
fetched_at: 2026-06-30T18:12:54.181Z
validated_at: 2026-06-30T18:12:54.181Z
stale_after: 2026-07-30T18:12:54.181Z
...
supplied_by: 
etag: 
last_modified: Tue, 30 Jun 2026 18:03:01 GMT
content_hash: ccca3dc451e3f171087d56ef235864d5c890fa9885391cb8282718371efdd8f2
token_estimate:
  compressed: 1339
  detailed: 2315
status: active
...
If you are a user of LLM systems that use tools (you can call them “AI agents” if you like) it is _critically_ important that you understand the risk of combining tools with the following three characteristics.
...
LLMs follow instructions in content.

The problem is that they don’t just follow _our_ instructions.
...
LLMs are unable to _reliably distinguish_ the importance of instructions based on where they came from.
...
I said “very good chance” because these systems are non-deterministic—which means they don’t do exactly the same thing every time.

#### This is a very common problem

Researchers report this exploit against production systems all the time.
...
The bad news is that once you start mixing and matching tools yourself there’s nothing those vendors can do to protect you!
...
Something as simple as a tool that can access your email?
...
The recently discovered [GitHub MCP exploit] provides an example where one MCP mixed all three patterns in a single tool.
...
Sadly neither of these are any help to end users who are mixing and matching tools together.

#### This is an example of the “prompt injection” class of attacks

I coined the term **prompt injection** [a few years ago], to describe this key issue of mixing together trusted and untrusted content in the same context.

Unfortunately, that term has become detached its original meaning over time.
...
As a user of these systems you _need to understand_ this issue.
...
Fetched from https://simonwillison.net/2025/Jun/16/the-lethal-trifecta/ on 2026-06-30T18:12:54.181Z