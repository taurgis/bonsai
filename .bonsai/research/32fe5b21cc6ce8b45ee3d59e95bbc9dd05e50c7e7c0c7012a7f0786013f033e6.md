...
source_url: https://nodejs.org/api/fs.html#fslchownpath-uid-gid-callback
source_urls:
  - https://nodejs.org/api/fs.html#fslchownpath-uid-gid-callback
normalized_url: https://nodejs.org/api/fs.html
cache_key: 32fe5b21cc6ce8b45ee3d59e95bbc9dd05e50c7e7c0c7012a7f0786013f033e6
topic: Node fs Stats
tags:
  - node
  - fs
...
content_hash: 74e15a181b4ade41629ce3c0c9e1280b9ddfc6f73eeb241446bdbbd4e0e2a1a3
token_estimate:
  compressed: 306
  detailed: 306
status: active
...
section_anchor: fslchownpath-uid-gid-callback
section_heading_path: File system > Callback API > `fs.lchown(path, uid, gid, callback)`
---

## Summary

File system > Callback API > `fs.lchown(path, uid, gid, callback)`
...
Section "File system > Callback API > `fs.lchown(path, uid, gid, callback)`" of https://nodejs.org/api/fs.html (parent e592a8e6818242987d359207b9042a5ad8f72a785792e1b5fcaa69c82fb3077a)