...
source_url: https://nodejs.org/api/fs.html#fsclosesyncfd
source_urls:
  - https://nodejs.org/api/fs.html#fsclosesyncfd
normalized_url: https://nodejs.org/api/fs.html
cache_key: c221638fc5181a5bbb873c9b9b92db6a4ff9810097a995d1216ad8c063dafe8f
topic: Node fs Stats
tags:
  - node
  - fs
...
content_hash: 1fa9a8d0b4784d234e9b7073c30036c14827488d475367ee7b2405b6e66dee40
token_estimate:
  compressed: 81
  detailed: 81
status: active
...
section_anchor: fsclosesyncfd
section_heading_path: File system > Synchronous API > `fs.closeSync(fd)`
---

## Summary

File system > Synchronous API > `fs.closeSync(fd)`
...
Section "File system > Synchronous API > `fs.closeSync(fd)`" of https://nodejs.org/api/fs.html (parent e592a8e6818242987d359207b9042a5ad8f72a785792e1b5fcaa69c82fb3077a)