...
source_url: https://oclif.io/docs/flags/
source_urls:
  - https://oclif.io/docs/flags/
normalized_url: https://oclif.io/docs/flags/
cache_key: 243a08291ae87892b12fa5edf2cba16aaffc520bcbb29b273bc4f9cb33fcc394
topic: 
tags:
  - flags
  - flag
...
supplied_at: 
supplied_by: 
etag: W/"6a37a275-14c92"
last_modified: Sun, 21 Jun 2026 08:36:05 GMT
content_hash: 347218634a9d9d23719cbb55a612937794129f2e6452c16aeae7316aced2e45d
token_estimate:
  compressed: 1697
  detailed: 1901
status: active
...
Flag options are non-positional arguments passed to the command. Flags can either be option flags which take an argument, or boolean flags which do not.
...
_oclif supports a wide range of [alternative flag inputs]._
...
In the Salesforce CLI we make heavy use of custom flags.
...
These and more are located [here] if you want to see more examples.

## Alternative Flag Inputs[​]

Here are some other ways the user can use input flags.
...
See our blog post [CLI Flags Explained] for a deeper dive into CLI flags.
...
_oclif supports a wide range of [alternative flag inputs](https://oclif.io/docs/flags#alternative-flag-inputs)._
...
## Custom Flags[​](https://oclif.io/docs/flags#custom-flags "Direct link to Custom Flags")
...
## Alternative Flag Inputs[​](https://oclif.io/docs/flags#alternative-flag-inputs "Direct link to Alternative Flag Inputs")
...
See our blog post [CLI Flags Explained](https://oclif.io/blog/2019/02/20/cli-flags-explained) for a deeper dive into CLI flags.

## Provenance

Fetched from https://oclif.io/docs/flags/ on 2026-06-27T10:57:47.054Z