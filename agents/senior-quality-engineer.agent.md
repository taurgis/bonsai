...
description: Runs post-implementation validation to detect regressions and
  confirm feature behavior. Use after implementing or updating a feature to run
  targeted checks and produce a clear pass or fail report.
...
tools:
  ...
  - browser
  - vscode/askQuestions
argument-hint: What feature or change should be tested?
metadata:
  version: 2.1.0
---
